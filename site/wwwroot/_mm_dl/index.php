...
$blob = $blobClient->getBlob($Folder, $blobfilename);
//getProperties()->getContentLength() 
$propResult = $blobClient->getBlobProperties($Folder, $blobfilename, null);
$blog_size = $propResult->getProperties()->getContentLength();
