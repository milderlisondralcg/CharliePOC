...
$(".checkAllDelete").change(function() {
    if (this.checked) {
        $('input:checkbox').children('.deleteEntry').each(function() {
            this.checked=true;
        });
    } else {
        $('input:checkbox').children('.deleteEntry').each(function() {
...
$(".checkAllUpdate").change(function() {
    if (this.checked) {
        $('input:checkbox').children('.updateEntry').each(function() {
            this.checked=true;
        });
    } else {
        $('input:checkbox').children('.updateEntry').each(function() {
...
function revertLocation(name, latlng, title, desc, add, countries){
    ...
    latlng.html('<input type="hidden" name="location_lng_hidden[]" value="'+latlng.find('input:hidden[name="location_lng_hidden[]"]').val()+'"/><input type="hidden" name="location_lat_hidden[]" value="'+latlng.find('input:hidden[name="location_lat_hidden[]"]').val()+'"/>'+latlng.find('input:hidden[name="location_lat_hidden[]"]').val()+", "+latlng.find('input:hidden[name="location_lng_hidden[]"]').val());
